...
title = Label(root, text="Password Generator",fg="Black", bg="#a9a9a9", font=("Arial", 15, 'bold')).place(x=200, y=10)
...
# Checkboxes
C1 = Checkbutton(root, bg="#a9a9a9", text="A-Z", variable=upper_case, onvalue=1, offvalue=0, command=progress_status)
C1.place(x=100, y=40)
C2 = Checkbutton(root, bg="#a9a9a9", text="a-z", variable=small_case, onvalue=1, offvalue=0, command=progress_status)
C2.place(x=180, y=40)
C3 = Checkbutton(root, bg="#a9a9a9", text="0-9", variable=num, onvalue=1, offvalue=0, command=progress_status)
C3.place(x=250, y=40)
C4 = Checkbutton(root, bg="#a9a9a9", text="Special Characters", variable=special_Chars, onvalue=1, offvalue=0, command=progress_status)
C4.place(x=320, y=40)

# Length scale
s1 = Scale(root, variable=length,from_=7, to=16,orient=HORIZONTAL, command=get_slider_value)
s1.place(x=550, y=40)
scale_lable = Label(root, bg="#a9a9a9", text="Length", font=("Arial", 11)).place(x=500, y=40)
strength_lable = Label(root, bg="#a9a9a9", text="Password Strength", font=("Arial", 12, "bold")).place(x=280, y=80)
...
btn = Button(master=root, text="Generate", fg="teal", font=("Arial", 10, 'bold'), command=generate_pass).place(x=300, y=150)
password_entry = Entry(root, width=30)
password_entry.place(x=220, y=200)
copy_btn = Button(master=root, text="Copy", fg="teal", font=("Arial", 10, 'bold'), command=copyclip).place(x=320, y=230)
